...
?>
<form method="POST" style="padding-bottom: 500px">
...
if (isset($_POST['modifier'])){
	$reclamation=new Reclamation($_POST['num_p'],$id_client,$vote,$commentaire,$_POST['reclame']);
	$reclamationC->modifierReclamation($reclamation,$num_r);

	echo "<script>alert(\"Modification réussie !\")</script>";
?>
	<script <script type="text/javascript">document.location.href="consulterReclamation.php?id_client=<?PHP echo $row['id_client']; ?>"</script>
<?PHP
}
?>
</body>
