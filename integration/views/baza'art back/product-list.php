...
<body>
                        ...
                        <li class="active">
                            <a class="has-arrow" href="index.html">
                              ...
                              <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="Add Product" href="addproduct.php"><i class="fa fa-bolt sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Add product</span></a></li>
    ...
    <div class="all-content-wrapper">
      ...
      while($s = $produit->fetch()) {
                                      $img='c'.$s['img_localisation']; 
                                      $stock=($s['size_xs']+$s['size_M']+$s['size_L']+$s['size_S']);
                                      $var=(string)$s['category'];
                                      $c=$cat->cherche($var);
                                    ?>
                                <tr>
                                    <td><img src="<?PHP echo $img?>" alt="" /></td>
                                    <td><?PHP echo $s['first_name']; ?></td>
                                    <td><?PHP echo $s['product_title']; ?></td>
                                    <td><?PHP echo $s['descreption']; ?></td>
                                    <td><?PHP echo $c->category; ?></td>
                                    <td><?PHP echo $s['price']; ?></td>
                                    <td><?PHP echo $s['final_price']; ?></td>
                                    <td><?PHP echo $s['quantity']; ?></td>
                                    <td><?PHP echo $stock ?></td>
                                    <td><?PHP echo $s['final_price']; ?></td>
                                    <td><?PHP echo $s['size_xs']; ?></td>
                                    <td><?PHP echo $s['size_S']; ?></td>
                                    <td><?PHP echo $s['size_M']; ?></td>
                                    <td><?PHP echo $s['size_L']; ?></td>
                                    <td>
                                        <a href="product-edit.php?action=modify&number=<?php echo $s['numero']; ?>"><button data-toggle="tooltip" onclick="" title="Edit" " 
                                         class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button> </a>
                                          <a href="ajouterremise.php?action=remise&n=<?php echo $s['numero']; ?>"><button data-toggle="tooltip" onclick="" title="solder" " 
                                         class="pd-setting-ed"><i class="fa fa-tags" aria-hidden="true"></i></button> </a>
                                        <a href="supprimerproduit.php?action=delete&amp;num=<?php echo $s['numero']; ?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                    </td>
                                </tr>
                                                               <?php
                           }    
      ...
      for($i=1;$i<=$pagesTotales;$i++) {
         if($i == $pageCourante) {
            ...
            <button style="width: 30px;height: 30px;position: relative;left: 38%;top:100%;" value=" <?PHP echo $i.' ';  ?> "> <?PHP echo $i.' ';  ?> </button> 
         <?PHP
         } else { ?>
           <button style="width: 30px;height: 30px;position: relative;left: 38%;top:100%;"> <?php echo '<a href="product-list.php?page='.$i.'">'.$i.'</a> '; ?>  </button>
      <?php
         }
      }
      ?>
