<?PHP
include "C:/wamp64/www/nouveau dossier/core/produitc.php";
...
<head>
    ...
    <title>Add product | jeweler - Material Admin Template</title>
...
<body>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard" href="index-1.html"><i class="fa fa-circle-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Dashboard</span></a></li>
                                <li><a title="Add Category" href="addcategory.php"><i class="fa fa-bolt sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Add category</span></a></li>
                                <li><a title="Category list" href="categorylist.php"><i class="fa fa-bolt sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">category list</span></a></li>
                                ...
                                <li><a title="Add product" onclick="total();" href="addproduct.php"><i class="fa fa-bolt sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Add Product </span></a></li>
    ...
    <div class="all-content-wrapper">
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="addcategory.php">Category Edit</a></li>
        ...
        <!-- ADD PRODUCT-->
<form id="regForm"  method="POST" action="steps.php" enctype="multipart/form-data">
  <h1>Ajouter un produit:</h1>
  <!-- One "tab" for each step in the form: -->
  <div class="tab">Description:
    <p><input placeholder="First name..." id="nmae" oninput="this.className = ''" name="first_name"></p>
    <p><input placeholder="Product Title..." id="title" oninput="this.className = ''" name="product_title"></p>
    <p><input placeholder="Product Description..."  oninput="this.className = ''" name="descreption"></p>
    <p><select  name="category" id="category"  oninput="this.className = ''"  style="position: relative;left:00px; width: 720px;height: 50px" >
  ...
  <div class="tab">Price:
 <p>  <input type="number" id="price" placeholder="Regular Price.."  oninput="this.className = ''" name="price" min="0" style="width: 700px"></p>
    <p>  <input type="number" id="tax" placeholder="Tax.."  oninput="this.className = ''" name="tax" min="0" style="width: 700px"></p>
    <p>  <input type="number" id="sale" placeholder="Sale Price"  oninput="this.className = ''" name="sale" min="0"style="width: 700px"></p>
  </div>
  <div class="tab">Quantity:
    <p>  <input type="number" placeholder="Quantity.." id="quantite"  oninput="this.className = ''" name="quantity" min="1" max="300" style="width: 700px"></p>
    <p>  <input type="number" placeholder="size xs.." id="q_xs" oninput="this.className = ''" name="size_xs" min="0" max="300" style="width: 700px"></p>
    <p>  <input type="number" placeholder="size S.." id="q_s" oninput="this.className = ''" name="size_S" min="0" max="300" style="width: 700px"></p>
    <p>  <input type="number" placeholder="size M.." id="q_m" oninput="this.className = ''" name="size_M" min="0" max="300" style="width: 700px"></p>
    <p>  <input type="number" placeholder="size L.." id="l_m" oninput="this.className = ''" name="size_L" min="0" max="300" style="width: 700px"></p>
  </div>
  <div class="tab">Pictures(1/2):
            <input type="hidden" name="size" value="1000000">
    <div>
      <input type="file" name="image">
    </div>
  </div>
    <div class="tab">More Detailed Pictures(2/2):
            <input type="hidden" name="size" value="1000000">
    <div>
  ...
  <td><input type="submit" onclick="total()" name="submit" value="ajouterproduit"></td>
  </div>

  <div style="overflow:auto;">
    <div style="float:right;">
      <button type="button" id="prevBtn" onclick="nextPrev(-1)">Previous</button>
      <button type="button" id="nextBtn"  onclick="nextPrev(1);total();">Next</button>
    </div>
  </div>
