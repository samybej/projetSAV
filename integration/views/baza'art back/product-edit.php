                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                       ...
                       <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="Add Category" href="addcategory.php"><i class="fa fa-pencil" aria-hidden="true"></i> <span class="mini-sub-pro">Add category</span></a></li>
                                <li><a title="Category list" href="categorylist.php"><i class="fa fa-tags sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">category list</span></a></li>
                                <li><a title="Product List" href="product-list.php"><i class="fa fa-file-image-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Product List</span></a></li>
                                <li><a title="Add Product" href="http://localhost/projet/views/baza'art%20back/addproduct.php"><i class="fa fa-bolt sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Add product</span></a></li>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    ...
                                    <li><a href="#reviews"><i class="fa fa-file-image-o" aria-hidden="true"></i>Quantity</a></li>
...
?>
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input id="firstname" type="text" class="form-control" placeholder="Article name" name='first_name' value="<?php echo "$data->first_name" ?>">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                        <input id="product" type="text" class="form-control" placeholder="Product Title" name="product_title" value="<?php echo "$data->product_title" ?>">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-ticket" aria-hidden="true"></i></span>
                                                        <textarea class="form-control" placeholder="Product Description" name="descreption" value="<?php echo "$data->descreption" ?>"> </textarea>
                                                    </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                     <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input id="regularprice" type="number" min="1" class="form-control" placeholder="Regular Price" name="price" value="<?php echo "$data->price" ?>">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-sticky-note-o" aria-hidden="true"></i></span>
                                                        <input id="tax" type="number" min="1" class="form-control" placeholder="Tax" name="tax" value="<?php echo "$data->tax" ?>">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input type="number" min="0" class="form-control" placeholder="Sale Price" name="sale" value="<?php echo "$data->sale" ?>">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                     <p><select  name="category"  style="position: relative;left:00px; width:500px;height:30px" >
                             ...
                             <div class="product-tab-list tab-pane fade" id="reviews">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="row">
                                                     <div class="input-group mg-b-pro-edt" style="position:relative;left:114px;">
                                                    <span class="input-group-addon"><i class="fa fa-adjust" aria-hidden="true"></i></span>
                                                        <input type="number" min="1" class="form-control" placeholder="Quantity" name="quantity" style="position:relative; width: 500px" value="<?php echo "$data->quantity" ?>">
                                                    </div>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt" style="position:relative;left:100px;">
                                                        <span class="input-group-addon"><i class="fa fa-tag" aria-hidden="true"></i></span>
                                                        <input type="number" min="0" class="form-control" placeholder="category" name="size_xs" style="position:relative; width: 500px" value="<?php echo "$data->size_xs" ?>">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt" style="position:relative;left:100px;">
                                                        <span class="input-group-addon"><i class="fa fa-tag" aria-hidden="true"></i></span>
                                                        <input type="number" min="0" class="form-control" placeholder="size_S" name="size_S" style="position:relative; width: 500px" style="position:relative; width: 500px" value="<?php echo "$data->size_S" ?>">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt" style="position:relative;left:100px;">
                                                        <span class="input-group-addon"><i class="fa fa-tag" aria-hidden="true"></i></span>
                                                        <input type="number" min="0" class="form-control" placeholder="size_M" name="size_M" style="position:relative; width: 500px" value="<?php echo "$data->size_M" ?>">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt" style="position:relative;left:100px;">
                                                        <span class="input-group-addon"><i class="fa fa-tag" aria-hidden="true"></i></span>
                                                        <input type="number" min="0" class="form-control" placeholder="size_L" name="size_L" style="position:relative; width: 500px" value="<?php echo "$data->size_L" ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="review-content-section" >
                                                    ...
                                                    <div class="row">
                                                       <?PHP $img='c'.$data->img_localisation; ?>
                                                      <button type="submit"  name="img_localisation" data-toggle="tooltip" title="Trash" class="pd-setting-ed" style="position: relative;top: -370px;left:40px"><i class="fa fa-trash-o" value="1" aria-hidden="true"></i></button>
                                                       <img src="<?PHP echo $img?>" alt=""/>
                                                    </div>
                                                    <div class="row">
                                                       <?PHP $img='c'.$data->img_details1_localisation; ?>
                                                      
                                                       <img src="<?PHP echo $img?>" style="position:relative;left: 650px;top: -600px ; width: 200px;height: 200px"  />
                                                       <button type="submit"  name="img_details1_localisation" data-toggle="tooltip" title="Trash" class="pd-setting-ed" style="position: relative;top: -675px;left:450px"><i class="fa fa-trash-o" value="2" aria-hidden="true"></i></button>
                                                    </div>
                                                    <div class="row">
                                                       <?PHP $img='c'.$data->img_details2_localisation; ?>
                                                       <img src="<?PHP echo $img?>" style="position:relative;left: 650px;top: -570px ;width: 200px;height: 200px"/>
                                                       <button type="submit" name="img_details1_localisation" data-toggle="tooltip" title="Trash" class="pd-setting-ed" style="position: relative;top: -650px;left:450px"><i class="fa fa-trash-o" value="3" aria-hidden="true"></i></button>
                                                    </div>
                                                      <input type="hidden" name="size" value="1000000">
                                                             <div style="position:relative;right: -700px">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                    ...
                                                    <button type="submit" name="modifier" class="btn btn-primary waves-effect waves-light m-r-10">Modify</button>
                                                    <button  type="submit" name="reset" onclick="test()" id="button"  class="btn btn-warning waves-effect waves-light">Reset</button>
                                                </div>
                                            </div>
                                        </div>
