...
i
	<script type="text/javascript" src="controleSAV.js"></script>
...
?>
<form method="POST" style="padding-bottom: 500px" onsubmit="return verif()">
	<div style=" height: 250px; padding-top: 70px; padding-left: 750px;">
<table>
<h2 style="padding-bottom: 60px;">Modifier Reclamation</h2>
<tr>
<td>numero du produit</td>
<td><input type="text" name="num_p" id="num_p" value="<?PHP echo $num_p ?>"></td>
</tr>
<tr>
<td>votre reclamation</td>
<td><input type="text" name="reclame" value="<?PHP echo $reclamation ?>"></td>
</tr>
<td></td>
...
if (isset($_POST['modifier'])){
	$reclamation=new Reclamation($_POST['num_c'],$id_client,$_POST['reclame']);
	$reclamationC->modifierReclamation($reclamation,$num_r);

	echo "<script>alert(\"Modification réussie !\")</script>";
?>
	<script  type="text/javascript">document.location.href="consulterReclamation.php?id_client=<?PHP echo $row['id_client']; ?>"</script>
<?PHP
}
?>
</body>
