			...
			<div class="col-3" >
				<a href="#" >
					...
					<a href="?action=view&amp;num=<?php echo $row['numero']; ?>"><button class="productViewBtn" name="quick">View Product</button></a>
									...
									<div class="pi-pic">
									<div class="pi-links">
										<a href="../core/ajoutCart.php?product_id=<?= $row['numero']; ?>" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
...
<div class="product-area" style="position:relative;top:<?PHP echo $top; ?>;left:400px;width: 10000px">
      ...
      for($i=1;$i<=$pagesTotales;$i++) {
         ...
         <?PHP
           ...
           <button style="width: 50px;height: 50px;position: relative;left: 38%;top:-50%;"> <?php echo '<a href="affpag.php?page='.$i.'">'.$i.'</a> '; ?>  </button>
      <?php
         }
      }
      ?>
...
$data=$produit1c->remplirchamps($numero);
		...
		<script type="text/javascript">
   			var num_p = "<?php echo $data->numero; ?>";
		</script>
		...
		<div class="productViewBoxDetail">
		    ...
		    <h2 class="p-title"><?PHP echo "$data->product_title";  ?></h2>
					...
					<div style>
					<form >		
					<div class="rate" id="avis" align="left">Add your review :	
					</br>		
    					...
    					<!--<textarea name="comment" id="reclame" cols="40" rows ="3"></textarea>-->
    				</br>
    				</br>
    					...
    					<div class="comment" align="left">Commentaires des clients :
							<div class="messages" style="overflow-y: scroll;"></div>
							<div id="delete" style="display: none;">
  						<input type="button" value="effacer votre commentaire"> </a>
  							</div>
					...
					<div class="fw-size-choose">
						...
						<div class="sc-item">
							...
							<label for="xxl-size">42</label>
											...
											<div style="display: inline-block;"><p> Avis General : </p></div> 
					    					<div id="moyenne_avis" style="width: 30px; height: 30px; display: inline-block;">
